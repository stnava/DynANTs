...
```{r vizcorrs}
pheatmap(cor(myroidf))
pheatmap(cor(myroidfThickness))
pheatmap(cor(myroidfArea))
pheatmap(cor(myroidf,myroidfThickness))
pheatmap(cor(myroidf,myroidfArea))
pheatmap(cor(myroidfThickness,myroidfArea))
```
